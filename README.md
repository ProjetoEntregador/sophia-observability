...
Este serviço tem por objetivo centralizar a visualização de dados coletados dos serviços de Notificação, Medicamentos e Farmácia, permitindo o acompanhamento em tempo real de métricas coletadas dos bancos de dados, logs, eventos de auditoria e alertas.
...
- Acompanhamento de métricas de cada banco
